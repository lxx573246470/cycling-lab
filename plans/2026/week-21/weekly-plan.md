---
title: "2026 Week 21 Weekly Plan"
week: 2026-W21
type: weekly-plan
tags:
  - cycling
...
- 如果疲劳、睡眠或心率异常，优先替换为 [恢复骑](../../library/recovery/recovery-spin.md) 或 [休息日](../../library/recovery/rest-day.md)。

## 新增计划规则

- 优先复用 `plans/library/` 中已有训练课。
- 如果 AI 生成了新的训练课，先新增到对应分类，再在本周表格中引用。
- 周计划只记录安排和引用，不复制完整训练课内容。
